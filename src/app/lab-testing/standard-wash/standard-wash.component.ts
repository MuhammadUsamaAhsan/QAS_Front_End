...
@Component({
  selector: 'app-standard-wash',
  templateUrl: './standard-wash.component.html',
  styleUrls: ['./standard-wash.component.scss'],
  providers: [SomeSharedService]
})
export class StandardWashComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.wash_type="standard_wash";

    this.id_ = this.route.snapshot.params["id"];
    if (this.id_ == null) {
      this.FetchAllOrders();
    }
    else {
